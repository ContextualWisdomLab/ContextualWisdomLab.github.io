...
## 2026-09-21 - External Link Visual Indicator
**학습:** target="_blank" 링크는 시각적 아이콘(예: 화살표)을 통해 사용자에게 새 탭에서 열림을 인지시키는 것이 접근성과 사용성에 좋습니다. 특히 버튼 형태가 아닌 일반 텍스트 링크의 경우 인지하기 어렵습니다.
**적용:** 전역 CSS나 인라인 HTML을 통해 시각적 요소를 추가할 수 있습니다. 여기서는 외부 링크 텍스트 옆에 ↗ 모양의 기호를 aria-hidden 처리하여 추가합니다.
