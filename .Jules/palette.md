...
## 2024-07-06 - Improve text contrast for --gold on light backgrounds
**Learning:** The CSS variable '--gold' fails WCAG AA contrast standards when used for text on white or light backgrounds (like '--paper' or '--white').
**Action:** Use alternatives like '--teal' for text on light backgrounds to ensure sufficient contrast, while retaining '--gold' only on dark backgrounds (like '--ink').
