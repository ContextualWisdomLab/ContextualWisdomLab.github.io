...
## 2026-09-26 - 외부 링크 시각적 인디케이터 추가
**학습:** 사용자가 외부 링크를 클릭하기 전에 새 창에서 열린다는 것을 인지할 수 있도록 시각적인 표시가 필요합니다. 이는 접근성과 사용자 경험을 향상시킵니다.
**적용:** 외부 링크 텍스트 옆에 `<span aria-hidden="true">&nbsp;↗</span>`를 추가하여 시각적 인디케이터를 제공하되, 스크린 리더에서는 무시되도록 합니다. 래퍼 내에서 `&nbsp;`를 사용하여 줄바꿈 시 아이콘이 홀로 떨어지는 것을 방지합니다.
