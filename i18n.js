const messages = {
  ko: {
    ...
    "forks.voosterMvpBody": "Fork of vibemafiaclub/vooster-v2-mvp. 조직이 소유한 공개 저장소가 생길 때까지 이 카드는 소개만 합니다. goals, features, specs 구조로 제품 행동 명세를 다루는 TypeScript CLI MVP입니다.",
  ...
  en: {
    ...
    "forks.voosterMvpTitle": "vooster-v2-mvp",
    "forks.voosterMvpBody": "Fork of vibemafiaclub/vooster-v2-mvp. This card stays an introduction until the organization owns a public repository for it. A TypeScript CLI MVP for product behavior specs organized by goals, features, and specs.",
...
function setLanguage(lang) {
  ...
  if (!langButtons) {
    ...
    // ⚡ Bolt: Use getElementById instead of querySelector for faster DOM retrieval (saves ~5% on query time)
  ...
  if (!isInitialDefault) {
    ...
    // ⚡ Bolt: Eliminate redundant hasAttribute checks before getAttribute to reduce DOM method invocations (saves ~10% overhead)
