const messages = {
  ko: {
    ...
    "projects.lead": "Fork가 아닌 공개 저장소입니다. 제품과 도구는 실제 문제를 풀기 위한 실험으로, 조직 자산은 연구실 소개와 공개 문서를 유지하기 위한 저장소로 구분합니다.",
    ...
    "projects.siteTitle": "ContextualWisdomLab.github.io",
    "projects.siteBody": "맥락지혜 연구실 홈페이지입니다. DIKW, Naruon, 로고, 연구와 제품 방향을 소개합니다.",
    "projects.profileTitle": ".github",
    "projects.profileBody": "조직 프로필과 공개 소개 자산을 관리하는 저장소입니다.",
  ...
  en: {
    ...
    "projects.lead": "These are public repositories that are not forks. Product and tool repositories are experiments for real problems; organization assets maintain the lab introduction and public documentation.",
    "projects.naruonTitle": "Naruon",
    ...
    "projects.siteTitle": "ContextualWisdomLab.github.io",
    "projects.siteBody": "The Contextual Wisdom Lab homepage introducing DIKW, Naruon, the logo, and the research-to-product direction.",
    "projects.profileTitle": ".github",
    "projects.profileBody": "The repository for the organization profile and public introduction assets.",
