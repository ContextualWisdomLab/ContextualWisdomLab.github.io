...
## 2026-08-02 - Above-the-fold SVG decoding optimization
**Learning:** Applying `decoding="async"` to critical above-the-fold SVG images (like LCP elements) can negatively impact performance by delaying their decoding until other main-thread tasks are finished.
**Action:** Remove `decoding="async"` from non-lazy above-the-fold SVGs to allow synchronous rendering and improve LCP.
