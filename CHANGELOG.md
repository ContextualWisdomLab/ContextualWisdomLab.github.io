...
## [Unreleased]
- **Ontology publication**: serve the authoritative LineageWeave ontology and its generated RDF serializations at the lowercase canonical namespace route, with exact source commit and SHA-256 provenance.
